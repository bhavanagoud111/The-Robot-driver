"""
API Service - Network-accessible automation service
This turns the Core Python program and AI Brain into a web-accessible API.
"""
...
from robot_driver_complete import RobotDriver, ProductSearchTask
...
app = FastAPI(
    ...
    description="Network-accessible web automation service with AI-powered task execution",
    version="1.0.0",
    docs_url="/docs",
    redoc_url="/redoc"
)
