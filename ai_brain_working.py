"""
AI Brain with MCP Integration - Working Version
...
class MCPPageAnalyzer:
    ...
    async def analyze_page_context(self) -> Dict[str, Any]:
        ...
        try:
            ...
            elements = await self.page.query_selector_all('input, button, a, select, textarea, [role="button"]')
            ...
            print(f"✅ Page analysis complete: {len(page_info['elements'])} elements, {len(page_info['structure']['headings'])} headings")
            return page_info
...
class AIBrain:
    ...
    async def generate_automation_plan(self, user_goal: str, page_context: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            if "book" in goal_lower or "product" in goal_lower:
...
class AIBrainMCP:
    """
    Complete AI Brain with MCP integration (Working version)
    """
...
async def main():
    ...
    """
    print("🧠 AI Brain with MCP Integration - Working Version")
    print("=" * 60)
